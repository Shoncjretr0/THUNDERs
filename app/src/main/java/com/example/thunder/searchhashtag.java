...
public class searchhashtag extends ArrayAdapter<post> {
    ...
    public searchhashtag(Activity context, List<post> buylistadapters) {
        super(context, R.layout.activity_searchhashtag, buylistadapters);
